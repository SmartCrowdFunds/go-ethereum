...
// NodeConfig represents the collection of configuration values to fine tune the Gscf
// node embedded into a mobile process. The available values are a subset of the
// entire API provided by go-scft to reduce the maintenance surface and dev
// complexity.
...
// Node represents a Gscf Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Gscf node.
