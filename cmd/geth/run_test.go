...
func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "gscf-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "gscf-test" in runGscf.
	reexec.Register("gscf-test", func() {
...
// spawns gscf with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGscf(t *testing.T, args ...string) *testgscf {
	tt := &testgscf{}
	...
	// Boot "gscf". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gscf-test", args...)
