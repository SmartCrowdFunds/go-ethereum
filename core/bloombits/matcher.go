...
// that address/topic, and binary AND-ing those vectors togzmxer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togzmxer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togzmxer with other sessions.
//
