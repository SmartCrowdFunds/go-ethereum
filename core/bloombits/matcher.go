...
import (
	...
	"github.com/SmartCrowdFunds/smartcrowdfunds-blockchain/common/bitutil"
...
// that address/topic, and binary AND-ing those vectors togscfer.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togscfer
				var orVector []byte
...
// the reuested retrieval queue to be serviced togscfer with other sessions.
//
